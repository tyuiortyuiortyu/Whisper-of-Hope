    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content" style="background: #FFFFFF; border-radius: 25px; box-shadow: 0 4px 20px rgba(0,0,0,0.10); border: none;">
            ...
            <div class="modal-header" style="border: none; background: #FFFFFF; padding: 10px 20px 8px; border-bottom: 1px solid #f0f0f0; display: flex; justify-content: space-between; align-items: center; border-radius: 25px 25px 0 0;">
                <h5 class="modal-title" id="profileModalLabel" style="font-size: 2.5rem; letter-spacing: 2px; color: #333; margin: 0; font-weight: 500;">{{ __('user.profile') }}</h5>
            ...
            <div class="modal-body" style="background: #FFDBDF; padding: 30px; border-radius: 0 0 25px 25px;">
                ...
                <div class="d-flex justify-content-end mb-3">
                    <button type="button" class="btn" 
                        ...
                        <i class="bi bi-pencil-square me-1"></i>{{ __('user.edit_profile') }}
                    </button>
                </div>
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        <label class="form-label fw-bold mb-2" style="color: #333; font-size: 0.9rem;">{{ __('user.name') }}</label>
                    ...
                    <div class="col-md-6">
                        <label class="form-label fw-bold mb-2" style="color: #333; font-size: 0.9rem;">{{ __('user.email') }}</label>
                    ...
                    <div class="col-md-6">
                        <label class="form-label fw-bold mb-2" style="color: #333; font-size: 0.9rem;">{{ __('user.phone_number') }}</label>
